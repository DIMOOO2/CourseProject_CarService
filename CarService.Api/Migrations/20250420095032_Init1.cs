    ...
    public partial class Init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Organizations", x => new { x.OrganizationId, x.TIN });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationTIN = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clients", x => x.ClientId);
                    table.ForeignKey(
                        name: "FK_Clients_Organizations_OrganizationId_OrganizationTIN",
                        columns: x => new { x.OrganizationId, x.OrganizationTIN },
                        principalTable: "Organizations",
                        principalColumns: new[] { "OrganizationId", "TIN" });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AutoPartId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArticulGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderedPartId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Amount = table.Column<int>(type: "int", nullable: false),
                    OrderId = table.Column<long>(type: "bigint", nullable: false),
                    AutoPartId = table.Column<long>(type: "bigint", nullable: false),
                    DepartureWarehouseId = table.Column<long>(type: "bigint", nullable: false),
                    ArrivalWarehouseId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_OrganizationId_OrganizationTIN",
                table: "Clients",
                columns: new[] { "OrganizationId", "OrganizationTIN" });
